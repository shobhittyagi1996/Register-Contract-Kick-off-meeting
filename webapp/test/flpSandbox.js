		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Register Contract Kick off Meeting",
									"targetURL": "#comsapregistercontract-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapregistercontract-display": {
								"semanticObject": "comsapregistercontract",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.registercontract",
									"url": sap.ui.require.toUrl("com/sap/registercontract")
								}
							}
						}
					}
